# Niru Hackathon Submission - Femora
...
Women's reproductive health management in Kenya and across Africa faces significant challenges that impact millions of lives daily. Traditional period tracking apps lack cultural relevance, fail to provide personalized insights based on individual cycle patterns, and don't address the full spectrum of reproductive health from adolescence through menopause.

**Key Problems:**

1. **Lack of Personalized Health Insights**: Most period tracking apps provide generic information that doesn't adapt to individual cycle patterns, symptoms, or cultural dietary preferences. Women need personalized, actionable advice that considers their unique hormonal fluctuations and health history.

2. **Cultural Irrelevance**: Existing solutions often recommend foods and practices that aren't accessible or culturally appropriate for African women. There's a critical gap in providing nutrition advice that incorporates local foods like sukuma wiki, omena, njahi, and other Kenyan staples.

3. **Limited AI Integration**: Current apps rely on static databases and simple algorithms, missing the opportunity to leverage generative AI for dynamic, context-aware health recommendations that evolve with the user's data.

4. **Incomplete Health Journey Coverage**: Most apps focus only on period tracking, ignoring the broader reproductive health journey including contraceptive management, menopause transition, and lifetime health records that are crucial for comprehensive care.

5. **Language and Accessibility Barriers**: Many solutions don't consider local contexts, making health information less accessible to women who need it most.

6. **Data Fragmentation**: Women's health data is often scattered across multiple platforms, making it difficult to identify patterns, share with healthcare providers, or track long-term health trends.

**Impact**: These gaps result in women making uninformed health decisions, missing early warning signs of reproductive health issues, and lacking culturally-relevant guidance for managing their cycles effectively. This is particularly critical in resource-constrained settings where access to healthcare professionals is limited.
...
Femora is an AI-powered menstrual health tracking platform that leverages generative AI to provide personalized, culturally-relevant health insights throughout a woman's reproductive health journey. Our solution addresses the critical gap in women's health technology by combining comprehensive data tracking with intelligent, context-aware AI assistance.
...
- Generates contextual advice that considers the user's current cycle phase
...
- **Symptom Management**: Pain levels, mood, energy, sleep quality, and other PMS symptoms
...
- Cloud-ready architecture for future expansion
- API-first design allowing integration with healthcare systems
...
1. **Research Phase**: Understanding user needs and cultural context
2. **Design Phase**: UI/UX design with accessibility focus
3. **Development Phase**: Agile sprints with feature implementation
4. **AI Integration**: Prompt engineering and API integration
5. **Testing Phase**: User testing and feedback incorporation
6. **Deployment**: Production-ready code with documentation
...
### Team
- Developer: LABOSO123
- Project: Femora - AI-powered menstrual cycle tracking app

### Repository
- GitHub: https://github.com/LABOSO123/Femora

### Demo
- Live Demo: http://localhost:3001 (when server is running)
- Features: AI insights, cycle tracking, diet planning, contraceptive management, menopause support

### Contact
- For questions or collaboration opportunities, please refer to the repository issues page.
